...
import argparse
import rotate
from color_de import Detect_marker
...
coords_top_grap_myself = [56.5, 170.0, 320.0, 85.0, 40.7, -180.0] #[56.5, 170.0, 315.0, 86.53, 40.7, -178.72]
...
coords_bottom_grap_myself = [56.5, 170.0, 220.0, 84.53, 40.7, -180.0] #56.5, 170.0, 310.0, 86.53, 40.7, -178.72
...
class gsdemo(object):
    ...
    def initialize_vision(self):
        ...
        self.colordetect = Detect_marker()      
    ...
    def pick_and_place_color(self):
        ...
        while cv.waitKey(1) < 0 and not done:
            ...
            frame = self.colordetect.transform_frame(img)
