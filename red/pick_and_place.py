...
# coords_top_grap = [56.5, 150.0, 320.0, 83.53, 40.7, -180.0] #[56.5, 170.0, 315.0, 86.53, 40.7, -178.72]
# coords_top_grap_ok = [61.5, 60.8, 340.8, 86.53, 45, -178.72]
coords_top_ready = [61.5, 80.8, 295.0, 86.53, 40.7, -178.72]
coords_top_grap = [56.5, 150.0, 320.0, 83.53, 40.7, -180.0] #[56.5, 170.0, 315.0, 86.53, 40.7, -178.72]
coords_top_grap_ok = [61.5, 60.8, 340.8, 86.53, 45, -178.72]
...
coords_bottom_grap = [56.5, 150.0, 245.0, 83.53, 40.7, -180.0] #56.5, 170.0, 310.0, 86.53, 40.7, -178.72
coords_bottom_grap_ok = [61.5, 60.8, 260.8, 86.53, 45, -178.72]
arm_speed = 35

find_obj_count_top_max = 3
find_obj_count_bottom_max = 5
find_obj_distance_max_top = 0.50
...
class gsdemo(object):
    ...
    def rotate_to_direct1(self):
        rotate.target_yaw = rotate.read_direct('direct_1.txt')
        rotate.init_node()
